...
if sys.version_info < tuple((int(val) for val in "2.7".split('.'))):
    sys.stderr.write("ERROR: qt_client requires Python {} or later\n".format(2.7))
    sys.exit(1)
...
PACKAGENAME = metadata.get('package_name', 'qt_client')
DESCRIPTION = metadata.get('description', 'Qt frontend to the cosmoscope server')
AUTHOR = metadata.get('author', 'Nicholas Earl')
AUTHOR_EMAIL = metadata.get('author_email', '')
LICENSE = metadata.get('license', 'unknown')
URL = metadata.get('url', 'http://cosmoscope-qt.rtfd.io')
